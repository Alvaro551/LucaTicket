...
public class CustomResponse<T> {
	...
	/**
	 * Crea una respuesta de éxito con el código de estado 200 y un mensaje
	 * predeterminado de éxito.
	 * 
	 * @param string
	 *
	 ...
	 * @return Una instancia de CustomResponse con un código de estado 200, mensaje
	 *         de éxito y la información proporcionada.
	 */
	...
	/**
	 * Crea una respuesta de conflicto con el código de estado 409 y un mensaje de
	 * conflicto personalizado.
	 *
	 * @param mensaje El mensaje de conflicto.
	 * @param objeto  La información a incluir en la respuesta.
	 * @param <T>     El tipo de información.
	 * @return Una instancia de CustomResponse con un código de estado 409, el
	 *         mensaje de conflicto y la información proporcionada.
	 */
	...
	/**
	 * Crea una respuesta de recurso eliminado con el código de estado 410 y un
	 * mensaje de recurso eliminado personalizado.
	 *
	 * @param mensaje El mensaje de recurso eliminado.
	 * @param objeto  La información a incluir en la respuesta.
	 * @param <T>     El tipo de información.
	 * @return Una instancia de CustomResponse con un código de estado 410, el
	 *         mensaje de recurso eliminado y la información proporcionada.
	 */
	...
	/**
	 * Crea una respuesta de recurso no encontrado con el código de estado 404 y un
	 * mensaje de recurso no encontrado.
	 *
	 * @param message El mensaje de recurso no encontrado.
	 * @param <T>     El tipo de información.
	 * @return Una instancia de CustomResponse con un código de estado 404, el
	 *         mensaje de recurso no encontrado y sin información.
	 */
	...
	/**
	 * Crea una respuesta de error interno del servidor con el código de estado 500
	 * y un mensaje de error interno.
	 *
	 * @param message El mensaje de error interno del servidor.
	 * @param <T>     El tipo de información.
	 * @return Una instancia de CustomResponse con un código de estado 500, el
	 *         mensaje de error interno y sin información.
	 */
