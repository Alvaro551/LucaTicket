...
public class CustomGlobalExceptionHandler  {
	...
	public ResponseEntity<CustomResponse<EventoResponse>> handleDataIntegrityViolationException(DataIntegrityViolationException e) {
	...
	public ResponseEntity<CustomResponse<EventoResponse>> handleHttpMessageNotReadable(HttpMessageNotReadableException e) {
	    return ResponseEntity.badRequest()
	            .body(new CustomResponse<>(HttpStatus.BAD_REQUEST.value(), "Solicitud sin cuerpo o cuerpo malformado", null));
	}

	@ExceptionHandler(Exception.class)
	public ResponseEntity<CustomResponse<EventoResponse>> handleAllExceptions(Exception e) {
	    return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
	            .body(new CustomResponse<>(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Error interno al crear el evento", null));
	}
