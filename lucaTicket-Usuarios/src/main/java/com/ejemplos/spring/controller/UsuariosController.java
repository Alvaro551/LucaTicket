...
public class UsuariosController {
     ...
     * @return ResponseEntity con el CustomResponse que contiene el usuario antes de ser borrado y el código de estado correspondiente.
     */
    @DeleteMapping("/{id}")
     ...
     * @return ResponseEntity con el CustomResponse que contiene el usuario actualizado y el código de estado correspondiente.
     */
    @PutMapping("/{id}")
    ...
    public ResponseEntity<CustomResponse<UsuarioResponseADD>> editarUsuario(
